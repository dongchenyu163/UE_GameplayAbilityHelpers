...
#include "SkeletalMeshActorWithGAS.generated.h"

UCLASS()
class GAMEPLAYABILITYHELPERS_API ASkeletalMeshActorWithGAS : public ASkeletalMeshActor, public FActorAbilityBasic
{
	GENERATED_BODY()

public:
	// Sets default values for this actor's properties
	ASkeletalMeshActorWithGAS();
